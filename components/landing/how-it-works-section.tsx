...
const steps = [
  {
    ...
    description: "Descreva o que você quer alcançar. Nossos especialistas ajudam a entender as dores do negócio e traduzem em soluções práticas.",
  ...
  },
  {
    ...
    description: "Criaremos uma solução 100% personalizada para o seu negócio. Não importam as integrações ou complexidade, nossa equipe se encarrega de tudo.",
  ...
  },
  {
    ...
    description: "Cresça suas operações sem limites, enquanto sua nova tecnologia cuida do trabalho pesado para você.",
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[112px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block">Defina.</span>
              <span className="block text-white/30">Implemente.</span>
              <span className="block text-white/10">Escale.</span>
            </h2>
          </div>
