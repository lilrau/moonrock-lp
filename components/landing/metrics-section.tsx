...
const metrics = [
  { 
    ...
    sublabel: "e melhorias adicionadas",
  },
  { 
    value: 99, 
    suffix: ".99%", 
    prefix: "",
    label: "Taxa de sucesso de resolução",
    sublabel: "máxima",
  },
  { 
    value: 37, 
    ...
    <section ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          ...
          {time ? `${time.toLocaleTimeString("pt-BR", { timeZone: "America/Sao_Paulo" })} America/Sao_Paulo` : ""}
              </span>
            </div>

            <div className="lg:grid lg:grid-cols-12 lg:gap-8 lg:items-end">
              <h2
          className={`lg:col-span-8 text-6xl md:text-7xl lg:text-[120px] font-display tracking-tight leading-[0.95] transition-all duration-1000 ${
          ...
          <span className="text-muted-foreground">em tempo real.</span>
              ...
              <p
          className={`mt-8 lg:mt-0 lg:col-span-4 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
            isVisible ? "opacity-100" : "opacity-0"
          }`}
              >
          Atendimento técnico 24/7, monitoramento proativo e chamados acionáveis para garantir que sua operação esteja sempre performando no seu melhor.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span>Melhorias e adições</span>
          <span>Treinamento</span>
          <span className="text-foreground">e outras equipes para lhe atender</span>
        </div>
      </div>
    </section>
  );
