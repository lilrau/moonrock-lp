...
const testimonials = [
  {
    quote: "Eu tinha uma equipe de 10 pessoas só para atendimento. Agora, um robô faz isso automaticamente, cortando custos e liberando pessoal.",
    author: "Sara Garcia",
    role: "CEO",
    company: "NovaEco",
    metric: { value: "60%", label: "Redução de pessoal" },
  },
  {
    quote: "Sempre quis sair das planilhas mas não sabia por onde começar. O processo foi simples e agora tenho um controle bem mais profissional.",
    author: "Marcus Faccioli",
    role: "Diretor Financeiro",
    company: "Tudo Certo Negociações",
    metric: { value: "2x", label: "Mais produtividade" },
  },
  {
    quote: "Meu CRM já tinha uma tonelada de dados, mas não conseguia extrair insights. Com a automação, minhas equipes de vendas e marketing estão mais alinhadas e produtivas.",
    author: "Elena Carneiro",
    role: "Head de Vendas",
    company: "Lugano Peças",
    metric: { value: "31.8%", label: "Aumento na conversão" },
  },
  {
    quote: "A diretoria sempre foi resistente a modernizar por motivos de segurança. A equipe técnica foi atenciosa e resolveu todas as nossas preocupações, até hoje não tivemos problemas.",
    author: "James Liu",
    role: "Gerente",
    company: "Esposito Móveis Planejados",
    metric: { value: "0", label: "Incidentes de segurança" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Confiança de times
              <span className="text-background/40"> da elite.</span>
            </h2>
          </div>
