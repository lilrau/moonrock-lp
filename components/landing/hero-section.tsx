...
const words = ["automatizam", "atendem", "vendem", "escalam", "otimizam", "transformam"];
    ...
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <video
          ...
          playsInline
          aria-hidden="true"
          className="w-full h-full object-cover opacity-80 object-[70%_center] sm:object-[58%_center] lg:object-[52%_center]"
        >
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        <div className="lg:max-w-[55%]">
          ...
          <div className="mb-12">
            ...
            >
              <span className="block whitespace-nowrap">Soluções digitais</span>
          ...
          >
            <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
              ...
              Automações e softwares inteligentes para o futuro da sua empresa
            </span>
          </div>
        </div>
      </div>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            { value: "1500+", label: "clientes finais atendidos" },
            { value: "43.7%", label: "de aumento nas vendas" },
            { value: "500+", label: "horas de trabalho manual economizadas" },
          ].map((stat) => (
