...
const regions = [
  { name: "Agentes WhatsApp", nodes: 12, status: "operacional" },
  { name: "Inteligência Artificial", nodes: 8, status: "operacional" },
  { name: "Softwares de Gestão", nodes: 6, status: "operacional" },
  { name: "Automações", nodes: 3, status: "operacional" },
];
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                Nossos nós de computação estão construídos para máxima redundância e latência mínima, garantindo que sua aplicação esteja sempre online e próxima dos seus usuários.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-8xl lg:text-[8.5rem] font-display leading-none">100%</span>
                <span className="text-2xl text-muted-foreground">seu</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                Os servidores da sua aplicação não serão divididos com outros clientes, garantindo desempenho consistente e segurança aprimorada. Tenha controle total sobre os recursos alocados para sua aplicação.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-200 ${
              ...
              <span className="block text-sm text-muted-foreground mt-2">Latência</span>
            </div>
          </div>
        </div>
