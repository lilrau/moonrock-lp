        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <Image
              ...
              width={28}
              height={28}
              className={`transition-all duration-500 ${isScrolled ? "opacity-100" : "invert"}`}
              priority
            />
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>MOONROCK</span>
            <span className={`font-mono transition-all duration-500 ${isScrolled ? "text-[10px] mb-4 text-muted-foreground" : "text-xs text-white/60"}`}>TM</span>
          </a>
