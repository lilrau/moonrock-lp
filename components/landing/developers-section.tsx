...
const features = [
  { 
    title: "Manutenção", 
    description: "Estaremos sempre aqui para garantir que tudo funcione perfeitamente."
  },
  { 
    title: "Atualizações Contínuas", 
    description: "Estamos constantemente melhorando e adicionando novos recursos para atender às suas necessidades."
  },
  { 
    title: "Contato", 
    description: "Nossa equipe e a sua sempre alinhadas durante e após a implementação."
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9]">
            Junte-se ao futuro.
            <br />
            <span className="text-muted-foreground">Ou fique no passado.</span>
          </h2>
        </div>
