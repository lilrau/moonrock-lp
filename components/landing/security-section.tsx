...
const securityFeatures = [
  {
    icon: Shield,
    title: "Execução isolada",
    description: "Cada tarefa roda em um ambiente isolado, eliminando riscos de contaminação cruzada.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Memória criptografada",
    description: "Dados criptografados em repouso e em trânsito.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Trilhas de auditoria completas",
    description: "Cada ação registrada e inspecionável.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Privilégio mínimo",
    description: "Princípio do privilégio mínimo implementado.",
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Autônomo sim,
            <br />
            <span className="text-muted-foreground">incontrolado, não.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Na MoonRock, segurança é prioridade máxima. Nossas soluções são projetadas desde o início para proteger seus dados, garantir conformidade e mitigar riscos. Com isolamento rigoroso, criptografia avançada e monitoramento contínuo, oferecemos a tranquilidade de que suas operações estão seguras, sem comprometer a inovação.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 pb-24 sm:pb-28 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Proteção ativa</span>
              <div className="mt-8">
